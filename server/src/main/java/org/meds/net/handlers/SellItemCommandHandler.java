 ...
 * @author Romman.
 */
@ClientCommand(ClientCommandTypes.SellItem)
public class SellItemCommandHandler extends CommonClientCommandHandler {
    ...
    public void handle(ClientCommandData data) {
        ...
        if (shop.buyItem(sessionContext.getPlayer(), prototype, count)) {
