 ...
 * @author Romman.
 */
@ClientCommand(ClientCommandTypes.InnStore)
public class InnStoreCommandHandler extends CommonClientCommandHandler {
    ...
    public void handle(ClientCommandData data) {
        ...
        sessionContext.getPlayer().getInn().tryStoreItem(prototype, count);
    }
}
