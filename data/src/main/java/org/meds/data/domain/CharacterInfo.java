...
public class CharacterInfo {
    ...
    private Map<ItemPrototype, CharacterInnItem> innItems = new HashMap<>();
    ...
    public Map<ItemPrototype, CharacterInnItem> getInnItems() {
        return innItems;
    }

    public void setInnItems(Map<ItemPrototype, CharacterInnItem> innItems) {
