...
import meds.database.entity.CharacterGuild;
import meds.database.entity.CharacterInfo;
import meds.database.entity.CharacterSkill;
...
public class Player extends Unit
{
    ...
    protected meds.Session session;
    ...
    public meds.Session getSession()
    {
        return this.session;
    }
    ...
    private boolean load()
    {
        ...
        // Location
        this.position = meds.Map.getInstance().getLocation(this.info.getLocationId());
